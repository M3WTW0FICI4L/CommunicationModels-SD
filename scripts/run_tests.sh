...
echo "======================================"
echo "- Backend core tests: tests/test_backend.py"
echo "- Benchmark tests: tests/test_benchmark.py"
echo "- Config tests: tests/test_config.py"
echo "- Consistency tests: tests/test_consistency.py"
echo "- Logger and package export tests: tests/test_logger_and_packages.py"
